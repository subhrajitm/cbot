class ModernDRAssistant {
    ...
    async startProcess(processType) {
        ...
        try {
            // Send to Flask API to start process
            const response = await fetch(`/api/process/${processType}`, {
                method: 'POST',
                headers: {
        ...
        const flowMap = {
            ...
            assistance: {
                ...
                raise_dr: (input) => {
                    ...
                    this.addMessageWithButton('View Ticket in CMS', '/cms');
...
<li><b>Monthly DRs (Jan–May):</b> Jan 7, Feb 15, Mar 18, Apr 17, May 15</li>
    ...
    async sendMessage() {
        ...
        try {
            ...
            const requestData = {
                message: message,
                process_type: this.currentProcess,
                session_id: this.sessionId
            };
